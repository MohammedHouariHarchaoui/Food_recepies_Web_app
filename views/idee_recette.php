...
<div style="padding:40px;" class="rounded-4">
<form id="insert_form" class="insert-form rounded-4" method="post" action="">
    <div class="input-field rounded-4">
        <table class="table  shadow-lg rounded-4" id="table_ingrediants" style="border-radius:20px;width:100%;">
            <tr>
            ...
            <tr id="clone">
                <td>
                    <select class="select-element" id="select1" name="ingrediants[]">
                        <?php
                            foreach ($nutritions as $nutrition) {
                                echo "<option class='select-element' value=".$nutrition['id'].">".$nutrition['nom']."  (".$nutrition['measureQuantity'].")</option>";
                            }
                        ?>
                    </select>
                </td>
        ...
        <center>
            ...
            <input type="submit" class="btn btn-success" name="save" id="save" value="recherche">
