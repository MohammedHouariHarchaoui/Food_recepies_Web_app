...
<script>
    ...
    $(document).ready(function(){
        ...
        var x = 1;
        var max = 25;
        var html = '<tr><td><textarea class="form-control" text="text" name="paragraphes[]" ></textarea></td><td><input class="btn btn-danger" type="button" name="remove" id="remove" value="remove"></td></tr>';
    })
...
<div class="d-flex justify-content-center align-items-center " style="min-height:100vh">
    ...
    <div class="input-field">
        <table class="table table-bordered rounded " id="table_field">
            <tr>
                <th>Les paragraphes</th>
                <th>Add or remove</th>
            </tr>
            <tr>
                <td><textarea class="form-control" text="text" name="paragraphes[]"></textarea></td>
    ...
    <div class="input-field">
        <table class="table table-bordered" id="table_ingrediants">
            ...
            <tr id="clone">
                <td><input type="file" class="form-select" id="select1" name="images[]" /></td>
