...
<header class="header">
        <nav class="navbar row navbar-expand-lg shadow-lg">
...
<div class="container mt-5 shadow-lg p-4 rounded" style="overflow:scroll;">
<table id="example" class="table  shadow-lg table-hover" style="width:100%;">
        <thead>
            <tr>
            <!-- <th>Id</th> -->
      <th>Nom</th>
...
?>
            <tr>
                <!-- <th scope="row"><?php echo $nutrition['id'] ?></th> -->
                <td><?php echo $nutrition['nom'] ?></td>
                <td><?php echo $nutrition['class'] ?></td>
                <td><?php echo $nutrition['measureQuantity'] ?></td>
                <td><?php echo $nutrition['saison'] ?></td>
                <td><?php echo $nutrition['healthy'] ?></td>
                <td><?php echo $nutrition['calorie'] ?></td>
                <td><img src="/images/nutritions/<?=$nutrition['image']?>" style="border-radius:15px;height:100px;width:120px;box-shadow:5px 5px 20px black;"/></td>
                <td> 
                    <a class="btn" style="background-color:#e74c3c;color:white;" href="/ingrediant?id=<?=$nutrition['id']?>">Consulte</a>
                </td>
            </tr>
    <?php    }
?>
