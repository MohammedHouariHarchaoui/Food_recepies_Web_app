...
?>
            <tr>
                ...
                <td style="display:none;"><?php echo $new['description'] ?></td>
                <td><?php echo $new['created_at'] ?></td>
                <td><a href="/admin/news/view?id=<?=$new['id']?>" class="btn btn-info">Afficher</a></td>
                <td><a href="/admin/news/edit?id=<?=$new['id']?>" class="btn btn-warning">modifier</a></td>
                <td><a href="/admin/news/delete?id=<?=$new['id']?>" class="btn btn-danger">supprimer</a></td>
            </tr>
    <?php    }
?>
