...
<div class="d-flex justify-content-center align-items-center " style="min-height:100vh">
    <div class="col-4">
        ...
        <?php echo new SelectNotationField($model,'difficulte',""); ?>
        ...
        <?php echo new SelectCategorieField($model,'categorie',""); ?>
        <?php echo new SelectNotationField($model,'notation',""); ?>
        <?php echo new SelectFeteField($model,'fete',""); ?>
