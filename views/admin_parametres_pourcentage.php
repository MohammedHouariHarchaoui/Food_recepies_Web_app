...
<div class="container mt-5 mb-5 p-4 rounded shadow-lg" >
<table id="example" class="table table-striped table-hover" >
        ...
        <tbody>
            <tr>
                <th scope="row"><?php echo $pourcentage['id'] ?></th>
                <td><?php echo $pourcentage['pourcentage'] ?></td>
                <td><?php echo $pourcentage['created_at'] ?></td>
                <td ><a href="/admin/parametres/pourcentage/edit" class="btn btn-warning">modifier</a></td>
            </tr>
</tbody>
</table>
