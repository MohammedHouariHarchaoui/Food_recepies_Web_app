...
<div class="container mt-5  p-4 rounded">
    <a href="/admin/nutritions/add" class="btn btn-success">Add nutrition</a>
</div>
...
?>
            <tr>
                ...
                <td><a href="/admin/nutritions/view?id=<?=$nutrition['id']?>" class="btn btn-info">Afficher</a></td>
                <td><a href="/admin/nutritions/edit?id=<?=$nutrition['id']?>" class="btn btn-warning">modifier</a></td>
                <td><a href="/admin/nutritions/delete?id=<?=$nutrition['id']?>" class="btn btn-danger">supprimer</a></td>
            </tr>
    <?php    }
?>
