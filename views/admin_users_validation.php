    ...
    foreach ($users as $user) {
        ?>
            <tr>
                ...
                <td><a href="/admin/users_validation/valider?id=<?=$user['id']?>" class="btn btn-warning">valider</a></td>
                <td><a href="/admin/users_validation/delete?id=<?=$user['id']?>" class="btn btn-danger">supprimer</a></td>
            </tr>
        <?php } ?>
    </tbody>
    <tfoot>
