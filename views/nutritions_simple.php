...
<table id="example" class="table table-condensed" style="">
        <thead style="overflow:scroll;width:200vw;">
            <tr class="bg-white mb-2" style="z-index:10;position:fixed;top:70px;left:0;overflow:scroll;width:100vw;">
                <th style="border-width:0px;color:white;">Voir nutrition</th>
                <th style="border-width:0px;color:white;" >Nom</th>
                <th style="border-width:0px;color:white;">Classe</th>
                <th style="border-width:0px;color:white;">Measure quantity</th>
        ...
        <tbody style="width:80vw;"  class="mt-5 p-4 row justify-content-evenly row-cols-3 g-3" style="position:relative;" >
        <?php 
    foreach ($nutritions as $recette) {
        ?>
            <tr class="col-3 card  me-2 mb-5 shadow-lg" >
                <!-- <th style="display:none;"><?php echo $recette['id'] ?></th> -->
                <td style="border-width:0px;"><a  href="/ingrediant?id=<?=$recette['id']?>"><img class='shadow-lg card-img img-fluid' style="height:200px;" src="/images/nutritions/<?=$recette['image']?>" /></a></td>
                <td class="fs-3" style="border-width:0px;"><?php echo $recette['nom'] ?></td>
                <td class="fs-5" style="border-width:0px;"><?php echo $recette['class'] ?></td>
                <td class="" style="border-width:0px;max-height:90px;overflow:clip;display:none;"><?php echo $recette['measureQuantity'] ?></td>
                ...
                <td style="border-width:0px;"><?php echo $recette['calorie'] ?> Kcal</td>
                <td style="border-width:0px;position:relative;"><a href="/ingrediant?id=<?=$recette['id']?>" class="btn mt-3" style="background-color:#e74c3c;color:white">Afficher plus</a></td>
            </tr>
        <?php } ?>
    </tbody>
</table>
...
<a href="/nutrition" style="margin:5px;top:5px;position:fixed;top:150px;left:0px;background-color:#e74c3c;color:white;" class="btn ">Plus d'options</a>
