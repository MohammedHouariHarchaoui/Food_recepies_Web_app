...
<div>
    ...
    if(Application::$app->user->status == 1): ?>
        <a href="/profile/propser_recette" class="btn" style="margin-bottom:20px;margin-top:30px;margin-left:20px;background-color:#e74c3c;color:white;">Proposer une recette</a>
        <a href="/profile/recettes_proposees" class="btn" style="margin-bottom:20px;margin-top:30px;margin-left:20px;background-color:#e74c3c;color:white;">Liste des recettes proposées</a>
    <?php endif; ?>
