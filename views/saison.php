...
<form action="" method="post">
    <select class="select-element" name="saison" class="form-select">
        <option class="select-element">Hiver</option>
        <option class="select-element">Printemps</option>
        <option class="select-element">Ete</option>
        <option class="select-element">Automne</option>
    </select>
