    ...
    foreach ($recettes as $recette) {
        ?>
            <tr>
                ...
                <td><a href="/admin/recettes/view?id=<?=$recette['id']?>&recette_proposer=1" class="btn btn-info">Afficher</a></td>
                <td><a href="/admin/recettes_validation/valider?id=<?=$recette['id']?>" class="btn btn-warning">valider</a></td>
                <td><a href="/admin/recettes_validation/delete?id=<?=$recette['id']?>" class="btn btn-danger">supprimer</a></td>
            </tr>
        <?php } ?>
    </tbody>
    <tfoot>
